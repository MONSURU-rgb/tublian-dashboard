...
export const Header = () => {
  ...
  return (
    <header className="p-3 md:p-5 flex justify-between text-[#FEFEFE] items-center pr-2 md:pr-7 space-grotesk z-[900] backdrop-opacity-0 bg-[#121212] !sticky top-0 md:border-b-[#1e1e1eeb]">
