...
export function MainPage() {
  return (
    <div className="bg-[#121212] md:pr-2 w-full h-screen overflow-y-auto mt-2 rounded-[20px_20px_0px_0px] border border-[#1e1e1eeb]">
      <Header />
      <div className="flex flex-col md:gap-4 gap-1 overflow-y-auto">
